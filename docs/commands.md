...
- [`scai audit baseline accept`](#scai-audit-baseline-accept) — Read a `ScaiEnvelope` from stdin (an audit's --json output) and add its findings to the baseline
