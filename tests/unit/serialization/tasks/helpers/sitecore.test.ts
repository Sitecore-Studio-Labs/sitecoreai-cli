...
describe("applySitecoreCommands", () => {
  let applySitecoreCommands: (typeof import("../../../../../src/serialization/tasks/helpers/sitecore"))["applySitecoreCommands"];

  beforeAll(async () => {
    ({ applySitecoreCommands } =
      await import("../../../../../src/serialization/tasks/helpers/sitecore"));
  });
