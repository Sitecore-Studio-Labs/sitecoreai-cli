/**
 * Sitecore Authoring GraphQL transport.
 *
 ...
 *
 * This is the cross-domain home of the Authoring transport: recipe was
 * the first heavy consumer, so it used to live in `recipe/api/graphql.ts`,
 * but deploy / publishing / content / hygiene / workflow / webhooks all
 * hit Authoring too. `recipe/api/graphql.ts` is now a published-API
