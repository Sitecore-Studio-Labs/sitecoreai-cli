...
import { resolveSiteRoot } from "../../../src/publishing/sitecore-api/sites";
...
vi.mock("../../../src/publishing/sitecore-api/path-resolver", () => ({
  resolveItemPathsToIds: vi.fn(),
}));

import { discoverSites } from "../../../src/recipe/api/site-discovery";
import { resolveItemPathsToIds } from "../../../src/publishing/sitecore-api/path-resolver";
