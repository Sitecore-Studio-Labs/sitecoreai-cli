...
import { dashifyGuid, type MediaFallback, sameLevelItemName } from "../api/ref-encoding";
import { layoutXmlEquivalent } from "../layout/parse";
import type { AuthoringApiClient, RemoteFieldValue, RemoteItem } from "../api/client";
...
import type { PrunedItemSnapshot, PlannedAction, PlanOptions } from "./plan-types";
import {
  lookupField,
  resolveAll,
  toUpdateItemInput,
  resolveCreateItemParent,
  resolveParentItemIdForFallback,
  createItemParentKey,
  isFolderClassCreate,
  convergenceEligible,
  markerHandleBase,
  isSyntheticAggregateHandle,
  resolveLiveTemplateIdForRebind,
  opHandleMarker,
  remoteHandleMarker,
  resolveTemplateOf,
  setFieldDesired,
  setBaseTemplatesDesired,
  resolveEffectiveBaseTemplates,
  setStandardValuesDesired,
  lookupSelector,
  parseMultiList,
  formatMultiList,
  readCurrentMaxVersion,
  MEDIA_FETCH_TIMEOUT_MS,
  MEDIA_FETCH_MAX_BYTES,
  isPrivateMediaHost,
} from "./plan-refs";
import { computeFieldDrift, resolveConflictStatus } from "./plan-drift";
