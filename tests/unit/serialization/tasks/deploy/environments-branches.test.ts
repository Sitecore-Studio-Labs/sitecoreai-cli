...
vi.mock(
  "../../../../../src/serialization/tasks/deploy/deployment-result",
  () => deploymentResultMock
);
...
vi.mock("../../../../../src/serialization/tasks/deploy/deployments", () => deploymentsMock);
...
describe("deploy environments branches", () => {
  ...
  it("filters project environments by type", async () => {
    ...
    const { runDeployEnvironmentsList } =
      await import("../../../../../src/serialization/tasks/deploy/environments");
  ...
  it("prints non-JSON project/name output for environments get", async () => {
    ...
    const { runDeployEnvironmentsGet } =
      await import("../../../../../src/serialization/tasks/deploy/environments");
