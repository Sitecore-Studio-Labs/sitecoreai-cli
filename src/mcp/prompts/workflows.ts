      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Step 7. **Verify** by calling `workflow_inspect verb='get' item: '<displayName>'`. Walk the user through the state tree the response returns.",
              "",
              "Guardrails:",
